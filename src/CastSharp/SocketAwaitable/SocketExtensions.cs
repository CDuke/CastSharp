...
namespace CastSharp.SocketAwaitable
{
    /// <summary>
    ...
    public static class SocketEx
    {
        ...
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static readonly Func<Socket, SocketAwaitable, bool> receiveToOp = (s, a) =>
            s.ReceiveAsync(a.Arguments);
        ...
        /// <summary>
        ///     Holds a delegate of <see cref="Socket" />'s sendTo operation.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static readonly Func<Socket, SocketAwaitable, bool> sendToOp = (s, a) =>
            s.SendToAsync(a.Arguments);
        ...
        ///     <see cref="Buffer" /> of the <paramref name="awaitable" /> is not
        ...
        {
            return OperateAsync(socket, awaitable, sendToOp);
        }
